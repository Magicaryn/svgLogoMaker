...
const fs = require('fs');
const generateLogo = require('./SVG.js')
    ...
    run() {
        return inquirer
            ...
            .then((response) => {
                ...
                const logoDetails = generateLogo(response);

                fs.writeFile('Logo.SVG', logoDetails, (err) => err ? console.log(err) : console.log('Successfully created personalized logo!'))
            });
    }
}
